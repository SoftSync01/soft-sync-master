      ...
      >
        ...
        <div className="flex justify-between mb-0 pr-3 sm:px-2">
          ...
          <header className="flex justify-between items-start mb-2">
            <img src={Icon} width="80" height="80" alt="Icon 01" />
            <div className="flex-container">
                <span className="text-xl font-large ml-5 lg:opacity-50 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 text-white">
                    SoftSync
                </span>
            </div>
          </header>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Commerce */}
              <SidebarLinkGroup activecondition={pathname.includes('commerce')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname.includes('commerce') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${pathname.includes('commerce') ? 'text-indigo-300' : 'text-slate-400'}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('commerce') ? 'text-indigo-600' : 'text-slate-700'}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('commerce') ? 'text-indigo-500' : 'text-slate-600'}`}
              ...
              {/* Finance */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('finance') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/finance"
                  className={`block text-slate-200 truncate transition duration-150 ${
